        ...
        <div class="max-w-7xl mx-auto">
            ...
            <?php if (is_home() && !is_front_page()) : ?>
                <header class="mb-12 text-center">
                    <h1 class="text-4xl sm:text-5xl font-bold mb-4">
                        <span class="text-gradient"><?php single_post_title(); ?></span>
                    </h1>
                </header>
            <?php endif; ?>
                    ...
                    <?php while (have_posts()) : the_post(); ?>
                        <article class="glass-card rounded-3xl p-6 group cursor-pointer">
                            ...
                            <div class="flex items-center justify-between text-sm text-gray-500">
                                ...
                                <a href="<?php the_permalink(); ?>" class="text-indigo-400 hover:text-indigo-300 flex items-center gap-1">
                                    Читать далее
            ...
            <?php else : ?>
                <div class="text-center py-20">
                    ...
                    <p class="text-gray-400 mb-8">По вашему запросу не найдено материалов</p>
                    <?php get_search_form(); ?>
                </div>
            <?php endif; ?>
